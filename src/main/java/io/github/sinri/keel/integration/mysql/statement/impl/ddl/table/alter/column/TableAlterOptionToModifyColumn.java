...
public final class TableAlterOptionToModifyColumn extends TableAlterOption {
     ...
     * @return 自身实例
     */
    public TableAlterOptionToModifyColumn setColumnName(String columnName) {
     ...
     * @return 自身实例
     */
    public TableAlterOptionToModifyColumn setColumnDefinition(String columnDefinition) {
     ...
     * @return 自身实例
     */
    public TableAlterOptionToModifyColumn placeAfter(String previousColumnName) {
