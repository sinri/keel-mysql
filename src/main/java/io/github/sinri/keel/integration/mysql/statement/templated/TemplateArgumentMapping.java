...
public class TemplateArgumentMapping extends HashMap<String, TemplateArgument> {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindNull(String argumentName) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindNumber(String argumentName, Number number) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindNumbers(String argumentName, Collection<? extends Number> numbers) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindString(String argumentName, String string) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindStrings(String argumentName, Collection<String> strings) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindExpression(String argumentName, String expression) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindExpressions(String argumentName, Collection<String> expressions) {
     ...
     * @return 自身实例
     */
    public TemplateArgumentMapping bindLineCommentStarting(String argumentName, boolean commentFromHere) {
